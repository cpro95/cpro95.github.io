...
summary: 자바스크립트의 핵심 개념인 비동기 처리를 배웁니다. 이벤트 루프와 큐의 동작 원리부터 시작해, 프로미스(Promise)와 async/await를 사용해 오래 걸리는 작업을 우아하게 처리하는 방법을 알아봅니다.
tags:
    - 비동기
    - 자바스크립트 프로미스
    - async/await
...
# 웹 개발 배우기 13편 - 기다림의 미학, 프로미스와 async/await로 비동기 정복하기
