...
summary: Node.js로 사용자를 인증하는 방법을 배웁니다. HTTP 기본 인증의 원리부터 시작해, 해싱과 솔팅을 통해 비밀번호를 안전하게 저장하는 방법까지, 서버 보안의 기초를 다집니다.
tags:
    - 사용자 인증
    - 로그인
    - HTTP 기본 인증
...
# 웹 개발 배우기 17편 - Node.js로 구현하는 로그인 기능, HTTP 기본 인증 정복하기
