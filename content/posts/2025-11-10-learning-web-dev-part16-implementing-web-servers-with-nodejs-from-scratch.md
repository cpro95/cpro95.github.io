...
summary: Node.js의 http 모듈을 사용해 직접 웹 서버를 구현하는 방법을 배웁니다. HTTP 요청과 응답의 기본 원리부터 시작해, 파일을 제공하고 API 요청을 처리하는 Todo 리스트 백엔드 서버를 만들어봅니다.
tags:
    - 웹 서버
    - Node.js
    - HTTP
...
# 웹 개발 배우기 16편 - 클라이언트와 서버의 만남, Node.js로 나만의 웹 서버 만들기
