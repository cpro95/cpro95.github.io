...
summary: 배우기 쉽고 널리 사용되는 경량 마크업 언어인 마크다운에 대해 알아봅니다. 마크다운의 기본 개념과 문법, 그리고 개발 문서 작성에 어떻게 활용되는지까지 핵심만 빠르게 살펴봅니다.
tags:
    - 마크다운
    - Markdown
    - 마크업 언어
...
# 웹 개발 배우기 번외 3편 - 개발자의 글쓰기 도구, 마크다운(Markdown) 빠르게 익히기
